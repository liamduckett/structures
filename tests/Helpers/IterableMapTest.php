...
class IterableMapTest extends TestCase
{
    ...
    {
        $result = iterable_map([1, 2, 3], fn (int $value) => $value * 2);
    ...
    {
        $result = iterable_map(new ArrayIterator([1, 2, 3]), fn (int $value) => $value * 2);
    ...
    public function testMapOverAGenerator(): void
    {
        ...
        $result = iterable_map($generator, fn (int $value) => $value * 2);
    ...
    {
        $result = iterable_map(['a' => 1, 'b' => 2], fn (int $value, string $key) => $key.$value);
    ...
    {
        $result = iterable_map(['a' => 1, 'b' => 2], fn (int $value) => $value * 2);
    ...
    public function testMapIsLazy(): void
    {
        ...
        iterable_map([1, 2, 3], function (int $value) use (&$calls): int {
            ++$calls;
